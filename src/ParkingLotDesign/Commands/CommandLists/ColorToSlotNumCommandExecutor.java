...
public class ColorToSlotNumCommandExecutor extends CommandExecutor {

    public static final String COMMAND_NAME = "slot_numbers_for_cars_with_color";
    public ColorToSlotNumCommandExecutor(ParkingLotService parkingLotService, OutputParser outputParser) {
